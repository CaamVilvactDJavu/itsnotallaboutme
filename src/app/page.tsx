    ...
    <div className="flex flex-col items-center justify-center text-center p-4">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-8 p-4">
        ...
        <div className="text-left max-w-4xl">
          <strong>こんにちは</strong>, You are in a place where all this is not
          who I really am. Because people I have met say I am
          <strong> a quiet person</strong> and maybe also
          <strong> an introvert</strong>, so I created this project to convey my
          complaints about my physical and mental life in living this life.
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-8 border-dashed border-t-2 border-[#1f1f1f] w-full">
        ...
        <div className="text-left max-w-4xl p-4">
          ...
          books, be it
          <strong> religion, philosophy, science, history</strong>, and others.
        </div>
      </div>
